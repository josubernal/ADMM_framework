...
def main():
    ...
    # Load CNN data
    cnn_path = os.path.join(base_dir, "feedforward", "results.json")
    ...
    # Load CSNN data
    csnn_path = os.path.join(base_dir, "spiking-feedforward", "results.json")
    ...
    if cnn_metrics:
        plot_model_row(axes[0], cnn_metrics, "Feedforward")
    if csnn_metrics:
        plot_model_row(axes[1], csnn_metrics, "Spiking Feedforward")
    ...
    save_path = os.path.join(base_dir, "feedforward_comparison_combined.pdf")
