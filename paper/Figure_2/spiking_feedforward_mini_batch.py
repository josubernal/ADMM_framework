...
minibatch_size_spiking = config.getint("config", "minibatch_size_spiking")
...
metrics = {}
metrics["architecture"] = "spiking-feedforward"
...
metrics_filename = "paper/results/mini_batch_spiking_feedforward/results.json"
