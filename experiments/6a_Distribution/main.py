...
def run_baseline(
    ...
    train_loader = get_dataset(
        batch_size=BATCH_SIZE, device=device, n_timesteps=N_TIMESTEPS, seed=seed
    )
...
if __name__ == "__main__":
    ...
    if args.mode == "baseline":
        run_baseline(
            ...
            THETAS,
            seed,
            save_path="experiments/6a_Distribution/results/baseline/results.json",
        )
    if args.mode == "baseline-cpu":
        run_baseline(
            ...
            THETAS,
            seed,
            save_path="experiments/6a_Distribution/results/baseline-cpu/results.json",
        )
    if args.mode == "adam":
        run_adam(
            EPOCHS,
            ...
            LR,
            seed,
            save_path="experiments/6a_Distribution/results/adam/results.json",
        )
    else:
        ...
        save_path = f"experiments/6a_Distribution/results/{folder_name}/results.json"
