...
if __name__ == "__main__":
    ...
    for batch_size in batch_sizes:
        ...
        metrics_filename = (
            f"experiments/4_Memory_benchmark/results/Old/{batch_size}/results.json"
        )
        ...
        metrics_filename = (
            f"experiments/4_Memory_benchmark/results/Unrolled/{batch_size}/results.json"
        )
        os.makedirs(os.path.dirname(metrics_filename), exist_ok=True)
        with open(metrics_filename, "w") as f:
            json.dump(metrics, f, indent=4)
        ...
        metrics_filename = f"experiments/4_Memory_benchmark/results/Unrolled_NoCache/{batch_size}/results.json"
        os.makedirs(os.path.dirname(metrics_filename), exist_ok=True)
        with open(metrics_filename, "w") as f:
            json.dump(metrics, f, indent=4)
        ...
        metrics_filename = f"experiments/4_Memory_benchmark/results/Decoupled/{batch_size}/results.json"
        os.makedirs(os.path.dirname(metrics_filename), exist_ok=True)
        with open(metrics_filename, "w") as f:
            json.dump(metrics, f, indent=4)
        ...
        metrics_filename = f"experiments/4_Memory_benchmark/results/Decoupled_NoCache/{batch_size}/results.json"
        os.makedirs(os.path.dirname(metrics_filename), exist_ok=True)
        with open(metrics_filename, "w") as f:
            json.dump(metrics, f, indent=4)
