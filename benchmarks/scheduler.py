...
from admm import (
 ...
 ADMM_CrossEntropy_Taylor, ADMM_SSE, ADMM_Scheduler
)
...
for model_name in model_types:
   ...
   #########################################
    ...
    admm_model._init_states(images)
    balancer = ADMM_Scheduler(admm_model, mu=10.0, tau=2.0, verbose=True, offload_to_cpu=False)
    ...
    metrics_filename2 = f"benchmarks/results/scheduler/{model_name}/{batch_size}/scheduler/results.json"
